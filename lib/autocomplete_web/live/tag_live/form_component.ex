defmodule AutocompleteWeb.TagLive.FormComponent do
  use AutocompleteWeb, :live_component

  alias Autocomplete.Contents
  ...
  def handle_event("validate", %{"tag" => tag_params}, socket) do
    changeset =
      socket.assigns.tag
      |> Contents.change_tag(tag_params)
  ...
  defp save_tag(socket, :edit, tag_params) do
    case Contents.update_tag(socket.assigns.tag, tag_params) do
      {:ok, tag} ->
